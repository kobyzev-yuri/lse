...
ML_CONTOUR_REGISTRY: Dict[str, MlContourSpec] = {
    ...
    "game5m_entry_bar_v2": MlContourSpec(
        contour_id="game5m_entry_bar_v2",
        display_name_ru="GAME_5M entry bar v2 (triple barrier, shadow)",
        data_unit="bar_candidate",
        refresh_script="scripts/run_game5m_entry_bar_v2_ml_refresh.py",
        train_metrics_relpath="last_game5m_entry_bar_v2_train_metrics.json",
        refresh_log_relpath="last_game5m_entry_bar_v2_ml_refresh.json",
        min_new_units_default=500,
        max_staleness_hours_default=168,
        poll_hours_default=168,
        supports_shadow=True,
        config_prefix="ML_GAME5M_ENTRY_BAR_V2",
    ),
    "game5m_continuation": MlContourSpec(
        contour_id="game5m_continuation",
        display_name_ru="GAME_5M continuation CatBoost (TAKE shadow)",
        data_unit="take_exit",
        refresh_script="scripts/run_game5m_continuation_ml_refresh.py",
        train_metrics_relpath="last_game5m_continuation_train_metrics.json",
        refresh_log_relpath="last_game5m_continuation_ml_refresh.json",
        min_new_units_default=10,
        max_staleness_hours_default=168,
        poll_hours_default=168,
        supports_shadow=True,
        config_prefix="ML_GAME5M_CONTINUATION",
    ),
