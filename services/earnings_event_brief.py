...
def build_event_brief(
    ...
    *,
    ...
    brief: dict[str, Any] = {
        ...
        # Numbers + LLM extract extras — notebook / report_expect consumers
        "revenue_actual": row.get("revenue_actual"),
        "revenue_estimate": row.get("revenue_estimate"),
        "eps_actual": row.get("eps_actual"),
        "eps_estimate": row.get("eps_estimate"),
        "revenue_surprise_pct": guidance.get("revenue_surprise_pct"),
        "eps_surprise_pct": guidance.get("eps_surprise_pct"),
        "ai_demand_signals": guidance.get("ai_demand_signals") or [],
        "margin_pressure_signals": guidance.get("margin_pressure_signals") or [],
        "inventory_or_supply_notes": guidance.get("inventory_or_supply_notes") or [],
        "qa_concerns": guidance.get("qa_concerns") or [],
