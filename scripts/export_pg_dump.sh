...
LSE_TABLES="quotes knowledge_base portfolio_state trade_history strategy_parameters earnings_event_detail earnings_material peer_graph_edge market_regime_daily event_reaction_dataset"
