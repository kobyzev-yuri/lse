...
6. **Риски** — ≥2 пункта.
7. **`filing_url`** (опционально) — прямая ссылка на 10-K / 10-Q / 20-F / IR PDF; иначе кнопка **SEC / filings** ищет по тикеру (см. §2.1).
...
| **Tagline, Маржа, Финансирование, Плюсы, Риски** | Не пишет | **Всегда Настя** на Фундаменте |
