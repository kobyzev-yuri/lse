...
После этого игра по SNDK работает: cron по расписанию проверяет 5m, при BUY/STRONG_BUY шлёт уведомление и пишет вход в trade_history; при SELL или через 2 дня — выход и PnL.
