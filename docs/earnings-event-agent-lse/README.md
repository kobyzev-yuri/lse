...
| [EARNINGS_EVENT_AGENT_IMPLEMENTATION_PLAN.md](EARNINGS_EVENT_AGENT_IMPLEMENTATION_PLAN.md) | **Рабочий план:** фазы 1–5, источники (календарь vs содержимое), cron, CatBoost MVP |
