...
### BUY и STRONG_BUY
**Сигналы на вход** разной силы уверенности.

- **STRONG_BUY** — высокая уверенность (перепроданность + отскок по RSI(5m), или confidence > 0,75 в стратегиях, или такая рекомендация от LLM). В 5m-правилах задаётся при RSI ≤ 32 и импульсе 2ч ≥ −0,3%.
- **BUY** — умеренный сигнал на вход (например, RSI у 5д минимума, импульс без перекупленности; в стратегиях — при меньшем confidence).
...
Подробнее: [GAME_SNDK.md](GAME_SNDK.md#buy-и-strong_buy-в-чём-разница).
