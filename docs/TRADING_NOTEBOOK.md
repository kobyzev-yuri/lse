...
| Фундамент / дома / env-ручное | **фундамент: регламент** | [`NOTEBOOK_FUNDAMENT_REGLEMENT.md`](NOTEBOOK_FUNDAMENT_REGLEMENT.md); дома/env п.12–13 открыты |
...
| # | Вопрос | Наш статус |
|---|--------|------------|
| 11 | Фундамент (эталон NBIS): все G2 или по запросу? | **закрыт** — ядро по запросу; см. [`NOTEBOOK_FUNDAMENT_REGLEMENT.md`](NOTEBOOK_FUNDAMENT_REGLEMENT.md) |
...
- **Фундамент** (шаблон NBIS): UI + overlay; регламент [`NOTEBOOK_FUNDAMENT_REGLEMENT.md`](NOTEBOOK_FUNDAMENT_REGLEMENT.md).
